...
// Updated vendor product routes with Vercel handler
router.post("/vendor-products", 
  authMiddleware.verifyToken, 
  authMiddleware.requireAdmin, 
  createUploadHandler(uploadVendorProducts.array('images', 5)), // Updated
  handleUploadErrors,
...
router.get("/vendor-products", vendorProductController.getAvailableProducts);

// Updated product update route
